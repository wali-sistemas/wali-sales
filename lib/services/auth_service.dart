...
/// LOGIN IGB
  Future<String?> login2(String usuario, String password) async {
    String empresa=GetStorage().read('empresa');
     final String apiUrl = 'http://wali.igbcolombia.com:8080/manager/res/app/login/'+empresa+'?user='+usuario+'&pass='+password;
    print("LOGIN: ----------------------////////------------");print (apiUrl);
    final response = await http.get(Uri.parse(apiUrl));

    if (response.statusCode==500)
    { return "Error, Datos incorrectos"; }
    else {
      print ("resp: **** " +response.body.substring(8,9));
