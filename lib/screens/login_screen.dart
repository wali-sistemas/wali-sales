...
import 'package:productos_app/screens/buscador.dart';
              ...
              padding: EdgeInsets.symmetric( horizontal: 45, vertical: 10),
                  ...
                  DropdownButton<String>(
                    ...
                    onChanged: ( newValue) {
                      ...
                      setState(() {
                        print ("Seleccionado: ");print(newValue);
                        if(newValue=="MOTOZONE")
                        {storage.write("empresa", "VARROC");print ("kkkkkkkkkkkkkkkkkkkkkk");}
                        else {storage.write("empresa", newValue);}
