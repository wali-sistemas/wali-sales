...
class CustomSearchDelegate extends SearchDelegate {
  ...
  Widget buildResults(BuildContext context) {
    ...
    {_pedidosBusqueda.clear();
      ...
      print("pedidosguardados::::::::::::::: ");print (pedidosGuardados);
      pedidosGuardados.forEach((k) {
        ...
        palabras.forEach((element) {
          if(k['cardCode'].toLowerCase().contains(element.trim().toLowerCase()) ||
          ...
          itemBuilder: (context, index) {
            return Card(
              child: Padding(
                ...
                child: ListTile(
                  title: Text('Fecha: '+_pedidosBusqueda[index]["docDate"].toString()+' - Nit: '+_pedidosBusqueda[index]["cardCode"].toString()+'\n'+'Número pedido: '+_pedidosBusqueda[index]["docNum"].toString()+'\n'+_pedidosBusqueda[index]["itemCode"].toString(),
                    style: TextStyle(
                      fontSize: 15,
                    ),
                  ),
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if (query==""){_pedidosBusqueda2=[];}

    print("_pedidosBusqueda2: ))))))))))))))))))"); print(_pedidosBusqueda2);
    return   ListView.builder(
        itemBuilder: (context, index) => ListTile(
          ...
          title: RichText(
              text: TextSpan(
                  text: 'Fecha: '+_pedidosBusqueda[index]["docDate"].toString()+' - Nit: '+_pedidosBusqueda[index]["cardCode"].toString()+'\n'+'Número pedido: '+_pedidosBusqueda[index]["docNum"].toString(),
                  style:
